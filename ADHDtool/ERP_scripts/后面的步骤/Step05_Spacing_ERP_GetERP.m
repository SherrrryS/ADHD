...
load([pwd '\param\Step1_param.mat']);
if ~exist('results'); mkdir('results'); end
input_folder_name='process';
output_folder_name='results';
% output_folder='ERP_results'; if isempty(output_folder); mkdir(output_folder); end
...
Conditions = {
    ...
    {events_select([1:3 7:9])};{events_select([12:15 19:21])};{events_select([25:27 31:33])};{events_select([4:6 10:12])}; {events_select([16:18 22:24])};{events_select([28:30 34:36])};%Lag&Mem: SF,MF,LF;
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
filename_tmp = dir('process\Clean_S*.mat');
