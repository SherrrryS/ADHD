...
sub_selected=[1:8];
sub_unselect=[ ];
% channel_selected=[25 62]; %N170 P2
% channel_selected=[39 40 46 45];%N400 
channel_selected=[20 31 57 58 30 63]; %LPC
% channel_selected=[39 40]; 
% time_window={[140 160]};%N170
% time_window={[210 240]};%P2
% time_window={[350 550]};%N400
time_window={[550 800]};%LPC
...
%     point_end=round((1000+time_window_tmp(2))*0.500);
    ...
    set(gca,'Ylim',[0,4])%LPC
%     set(gca,'Ylim',[4,8])%p2
%     set(gca,'Ylim',[-10,-4])%N170
%     set(gca,'Ylim',[-2,0])%N400
