function stats = RMAOV33(X,alpha)
...
stats = {'Source','SS','df','MS','F','p';...
         'IV1', SSA, v1, MSA, F1, P1;...
         'IV1 x subj', SSEA, v2, MSEA, [], [];...
         'IV2', SSB, v3, MSB, F2, P2;...
         'IV2 x subj', SSEB, v4, MSEB, [], [];...
         'IV3', SSC, v5, MSC, F3, P3;...
         'IV3 x subj', SSEC, v6, MSEC, [], [];...
         'IV1 x IV2', SSAB, v7, MSAB, F4, P4;...
         'IV1 x IV2 x subj', SSEAB, v8, MSEAB, [], [];...         
         'IV1 x IV3', SSAC, v9, MSAC, F5, P5;...
         'IV1 x IV3 x subj', SSEAC, v10, MSEAC, [], [];...
         'IV2 x IV3', SSBC, v11, MSBC, F6, P6;...
         'IV2 x IV3 x subj', SSEBC, v12, MSEBC, [], [];...
         'IV1 x IV2 x IV3', SSABC, v13, MSABC, F7, P7;...
         'IV1 x IV2 x IV3 x subj', SSEABC, v14, MSEABC, [], []};
return;